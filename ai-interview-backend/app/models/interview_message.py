"""InterviewMessage ORM 模型 — 面试会话内的多轮消息

字段：
- id / interview_id / role（interviewer / candidate）/ content
- question_index / score (DECIMAL) / feedback：评分与点评信息

关系：
- interview -> Interview（多对一）
"""
