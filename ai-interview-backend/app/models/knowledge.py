"""知识库 ORM 模型 — KnowledgeDocument + KnowledgeChunk

字段：
- KnowledgeDocument：id / title / file_name/url/type/size / category / tags (JSONB) /
  description / chunk_count / status / error_message / uploaded_by / is_active
