"""岗位模板 ORM 模型 — Agent 岗位匹配的核心数据源

字段：
- id / position_tag / title / category / level
- core_skills / nice_to_have_skills / project_keywords / focus_topics /
  recommended_query_keywords / typical_companies（均为 JSONB）
- recommended_difficulty / recommended_question_count / jd_summary / sort_order / is_active
